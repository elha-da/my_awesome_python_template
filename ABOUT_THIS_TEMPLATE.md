...
├── my_awesome_python_template             # The main python package for the project
...
e.g: `cat my_awesome_python_template/VERSION` will get the project version without harming
